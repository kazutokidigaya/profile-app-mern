...
const prompts = [
  "Please provide a detailed analysis of the attached resume for an MBA application with a focus on personalized and actionable advice. evaluate the profile based on multiple parameters by one of the top MBA admissions counsellors in the country. Keep the tone in first person and conversational and mentor like tone and simple language. Then put the table of content ( call it Key Highlights of <add name>’s Profile Evaluation)1. Detailed Summary of Background and Experience: [Elaborate on the candidate’s education, work history, key skills, and interests. Highlight any unique aspects or achievements. Mention how these experiences can be an asset in an MBA program. Also add some points on areas of improvement] 2. Suitability for an MBA: [Discuss how the candidate’s specific experiences and career goals align with pursuing an MBA. Provide insights on how an MBA could bridge gaps in their current skill set or career trajectory. Add a few pos-MBA roles that could be considered and bold out these roles.] 3. Field of Specialization Advice: [Based on the candidate’s unique background and aspirations, suggest specific MBA specializations. Explain why these specializations are a good fit and how they can help in achieving their career goals. Here also add that if they opt for a Non-MBA career path ( Highlight this and add in another line), what could be the possible career options] 4. Program and Geography Recommendations: [Recommend MBA programs and locations based on the candidate’s professional experience and personal preferences. Offer reasons for each recommendation and how they align with the candidate’s career path.Pick the top programs only from the Financial times MBA ranking list this year (browse for this)] 5. Key Considerations: [Offer practical advice on financial planning, balancing work and study, and preparing for MBA admissions. Suggest resources or steps they can take to address these areas.] 6. Other Considerations: [Discuss factors such as cultural fit, networking opportunities, and long-term career planning, tailored to the candidate’s background and goals.] Please use direct, encouraging language, offering guidance like a mentor who understands the candidate’s unique journey and potential. Keep readability as a top priority and break down complex sections into paras and bullet points wherever needed. THE SIGNATURE CAN BE Team Crackverbal  The table of content should be shown in the box on the page.",
];
